    ...
    <div class="wrapper">
        <ul class="resp-toggle">
            ...
            <?php if( osc_is_web_user_logged_in() ) { ?>
                <li>
                    <?php echo sprintf(__('Hi %s', 'matrix'), osc_logged_user_name() . '!'); ?>  &middot;
            ...
            <?php } else { ?>
                <li><a href="<?php echo osc_user_login_url(); ?>"><?php _e('Login', 'matrix'); ?></a></li>
                <?php if(osc_user_registration_enabled()) { ?>
                    <li>
                        <a href="<?php echo osc_register_account_url(); ?>"><?php _e('Register for a free account', 'matrix'); ?></a>
                    </li>
                <?php } ?>
            <?php } ?>
            <?php } ?>
            ...
            <li class="publish">
                <a href="<?php echo osc_item_post_url_in_category(); ?>"><?php _e("Publish your ad for free", 'matrix');?></a>
            </li>
            <?php } ?>
        </ul>
        <ul>
        ...
        ?>
            <li>
                <a href="<?php echo osc_contact_url(); ?>"><?php _e('Contact', 'matrix'); ?></a>
            </li>
        </ul>
        <?php if( (!defined('MULTISITE') || MULTISITE==0) && osc_get_preference('footer_link', 'matrix') !== '0') {
